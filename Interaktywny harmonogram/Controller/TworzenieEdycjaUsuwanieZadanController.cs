...
{
    internal class TworzenieEdycjaUsuwanieZadanController
    {
        private static TworzenieEdycjaUsuwanieZadanController instance = new TworzenieEdycjaUsuwanieZadanController();
        private TworzenieEdycjaUsuwanieZadanController() { }
        public void DodajZadanieDoMacierzy(string[] daneZadania, string kategorie)
        {
            ...
            ZapisywanieDanychController ZDController = ZapisywanieDanychController.GetInstance();
        ...
        public static TworzenieEdycjaUsuwanieZadanController GetInstance() { return instance; }
    }
}
